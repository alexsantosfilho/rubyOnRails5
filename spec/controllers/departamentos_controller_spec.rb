...
RSpec.describe DepartamentosController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: departamento.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      departamento = Departamento.create! valid_attributes
      get :edit, params: {id: departamento.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Departamento" do
        expect {
          post :create, params: {departamento: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {departamento: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested departamento" do
        departamento = Departamento.create! valid_attributes
        put :update, params: {id: departamento.to_param, departamento: new_attributes}, session: valid_session
        departamento.reload
      ...
      it "redirects to the departamento" do
        departamento = Departamento.create! valid_attributes
        put :update, params: {id: departamento.to_param, departamento: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        departamento = Departamento.create! valid_attributes
        put :update, params: {id: departamento.to_param, departamento: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested departamento" do
      departamento = Departamento.create! valid_attributes
      expect {
        delete :destroy, params: {id: departamento.to_param}, session: valid_session
      }.to change(Departamento, :count).by(-1)
    end
